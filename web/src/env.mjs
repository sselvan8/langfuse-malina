...
export const env = createEnv({
  ...
  server: {
    ...
    LANGFUSE_DEFAULT_PROJECT_ROLE: z
      ...
      .optional(),
    // CTH_AI project: Azure group-based auto-provisioning
    LANGFUSE_CTH_AI_PROJECT_ID: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    LANGFUSE_CTH_AI_PROJECT_ID: process.env.LANGFUSE_CTH_AI_PROJECT_ID,
